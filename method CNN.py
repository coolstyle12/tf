...
with tf.Session() as sess:
    ...
    for i in range(1001):
        ...
        if i%100 == 0:
            ...
            print ("step: %d, cost: %g, train_accuracy: %g" % (i, cross_entropy, train_accuracy))


    print ("test accuracy: %g" % (sess.run(accuracy, feed_dict={X: batch_xs, Y: batch_ys, keep_prob: 1.0})))